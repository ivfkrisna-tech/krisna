      ...
      <main>
        <section className="page-header">
          <div className="page-header-content reveal active">
            ...
            <div className="breadcrumb">
              <Link to="/">Home</Link> <span style={{ margin: '0 5px', opacity: '0.6' }}>/</span> Certificates
            </div>
          </div>
        </section>
        ...
        <section className="section reveal" style={{ padding: 'var(--section-padding)' }}>
          <div className="cert-intro">
            <h2 style={{ fontFamily: "'Playfair Display', serif", marginBottom: '20px' }}>Standards of <span style={{ color: 'var(--brand-teal)' }}>Excellence</span></h2>
          ...
          <div style={{ textAlign: 'center', marginTop: '60px' }}>
            <Link to="/" className="btn-primary" style={{ background: 'transparent', color: 'var(--brand-pink)', border: '2px solid var(--brand-pink)', boxShadow: 'none' }}>&larr; Back to Home</Link>
          </div>
        </section>
