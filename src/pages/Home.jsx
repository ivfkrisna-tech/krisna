      ...
      <main>
          ...
          <div className="container-hero">
            <div className="hero-txt-col">
              ...
              <div className="hero-actions">
                <Link to="/contact" className="btn-primary pulse-btn">Book Consultation</Link>
                <Link to="/success" className="btn-hero-outline">
        ...
        <section className="section reveal" style={{ padding: 'var(--section-padding)', background: '#f4fcfc' }}>
          ...
          <div className="grid-services">
            <div className="service-card">
              ...
              <h3>IVF Treatment</h3>
              <p>Advanced In-Vitro Fertilization using state-of-the-art lab technology for higher success rates.</p>
              <Link to="/ivf" className="service-link" aria-label="Learn more about IVF Treatment">Read More <i className="fa-solid fa-arrow-right"></i></Link>
            </div>
            <div className="service-card">
              <i className="fa-solid fa-syringe service-icon"></i>
              <h3>IUI Procedure</h3>
              <p>A less invasive first step for many couples, optimizing timing and sperm quality.</p>
              <Link to="/iui" className="service-link" aria-label="Learn more about IUI Procedure">Read More <i className="fa-solid fa-arrow-right"></i></Link>
            </div>
            <div className="service-card">
              <i className="fa-solid fa-hand-holding-heart service-icon"></i>
              <h3>Donor Program</h3>
              <p>Ethical and strictly screened donor egg/sperm programs to help complete your family.</p>
              <Link to="/donor" className="service-link" aria-label="Learn more about Donor Program">Read More <i className="fa-solid fa-arrow-right"></i></Link>
            </div>
            <div className="service-card">
              <i className="fa-solid fa-user-md service-icon"></i>
              <h3>Fertility Surgery</h3>
              <p>Minimally invasive laparoscopy and hysteroscopy to correct anatomical issues.</p>
              <Link to="/fertility_surgery" className="service-link" aria-label="Learn more about Fertility Surgery">Read More <i className="fa-solid fa-arrow-right"></i></Link>
            </div>
          </div>
        </section>
        ...
        <section className="section reveal" style={{ padding: 'var(--section-padding)' }}>
          ...
          <div className="gallery-grid">
            <Link to="/clean_room_crtfd_lab" className="gallery-item">
            ...
            <Link to="/our_team" className="gallery-item">
            ...
            <Link to="/equipment" className="gallery-item">
            ...
            <Link to="/certificates" className="gallery-item">
              <img src="/img/homepage5.img.png" alt="Medical Accreditations and Awards" loading="lazy" />
              <div className="gallery-overlay">
                <div className="gallery-txt">
          ...
          <div className="why-section">
            <div className="why-grid">
              ...
              <div>
                ...
                <Link to="/aboutus" className="btn-primary" style={{ marginTop: '20px' }}>More About Us</Link>
              </div>
            </div>
          </div>
        </section>
